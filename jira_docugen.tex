...
metadata from the Summit Facility to the Base facility.
 \\ \cdashline{1-2}
Requirement Discussion &  
 \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
...
transfer one night of data via the network secondary link.
 \\ \cdashline{1-2}
Requirement Discussion &  
 \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
...
interval to transfer a full Crosstalk Corrected Exposure and all related
metadata from the Base Facility to the Archive Center.
 \\ \cdashline{1-2}
Requirement Discussion &  
 \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
...
outage of active DM production.
 \\ \cdashline{1-2}
Requirement Discussion &  
 \\ \cdashline{1-2}
