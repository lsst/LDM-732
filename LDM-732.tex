...
Observatory Network (as defined in \citeds{LSE-78} LSST Observatory Network), and the methods and
...
The Data Management Subsystem Requirements (\citeds{LSE-61}, aka DMSR) drive the LSST Observatory
...
Note that the Observatory System Specifications (\citeds{LSE-30}, aka OSS) also include general requirements
