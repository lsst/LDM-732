...
\setDocAbstract {
The Network Verification Elements document and associated \href{https://jira.lsstcorp.org/projects/LVV/}{LSST Verification and Validation (LVV)} Jira project define the flow-down of specifications from higher level documents to the Observatory Network (as defined in \citeds{LSE-61} Data Management System (DMS) Requirements), as well as identifying the methods and resources that will be used to verify that network requirements have been met.
}
...
As such, all of the Verification Elements governed by this document and defined in the \href{https://jira.lsstcorp.org/projects/LVV/}{LSST Verification and Validation (LVV)} Jira project are Lower Level (LL) in the System Engineering test hierarchy.
