...
As such, all of the Verification Elements governed by this document and defined in the \href{https://jira.lsstcorp.org/projects/LVV/}{LSST Verification and Validation JIRA Project (LVV)} are Lower Level (LL) in the System Engineering test hierarchy.
